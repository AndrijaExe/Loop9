...
/**
 *  In-game HUD: sprint meter, crosshair, interaction prompts
 */
UCLASS()
...
protected:
	...
	UFUNCTION(BlueprintImplementableEvent, Category="UI", meta = (DisplayName = "Sprint Meter Updated"))
	void BP_SprintMeterUpdated(float Percent);

	/** Passes control to Blueprint to update the sprint meter status */
	UFUNCTION(BlueprintImplementableEvent, Category="UI", meta = (DisplayName = "Sprint State Changed"))
	void BP_SprintStateChanged(bool bSprinting);

	/** Passes control to Blueprint to update interaction prompt */
	UFUNCTION(BlueprintImplementableEvent, Category="UI", meta = (DisplayName = "Interaction Prompt Updated"))
