	...
	if (IsLocalPlayerController())
	{
		if (SVirtualJoystick::ShouldDisplayTouchInterface())
		{
			...
			if (MobileControlsWidget)
			{
				...
				UE_LOG(LogLoop9, Error, TEXT("Could not spawn mobile controls widget."));
		...
		if (BulletCounterUI)
		{
			...
			UE_LOG(LogLoop9, Error, TEXT("Could not spawn bullet counter widget."));
