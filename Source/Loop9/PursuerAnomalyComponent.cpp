...
#include "PursuerAnomalyCharacter.h"
#include "PursuerSpawnPoint.h"
...
void UPursuerAnomalyComponent::ActivateAnomaly()
{
	if (bIsAnomalyActive || !PursuerClass)
	{
		return;
	}
...
void UPursuerAnomalyComponent::DeactivateAnomaly()
{
	if (!bIsAnomalyActive)
	{
		return;
